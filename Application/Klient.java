...
public class Klient extends Osoba
{
   ...
   public Klient()throws SQLException
    ...
    public void zglos_szkode(String opis,Double oplata,Integer id_polisy,Integer d_z,Integer m_z,Integer r_z) throws SQLException { zgloszenie.utworz(opis,oplata,id_polisy,d_z,m_z, r_z); }
    public void edytuj_zgloszenie(Integer id, String opis,Double oplata,Integer id_polisy,Integer d_z,Integer m_z,Integer r_z) throws SQLException { zgloszenie.edytuj(id,opis,oplata,id_polisy,d_z,m_z, r_z); }
